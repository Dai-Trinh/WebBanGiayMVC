                ...
                <ul>
                    ...
                    <li class="menusanpham"><a target="_parent">SẢN PHẨM</a>
                        <ul class="menucon1">
                            ...
                            <li class="menuquan"><a href="">Sản phẩm nổi bật</a>
                            ...
                            <li class="menudobo"><a href="">Sản phẩm bán chạy</a>
...
<%--                    </li>--%>
            ...
            <div id="timkiem">
                <form action="${base }/tim-kiem-san-pham" method="get" id="form-tim-kiem">
                    <p style="margin: 0; width: 100%;">
                        <input type="search" placeholder="Tìm kiếm..." name="tensanpham" class="ten-san-pham" style="height: 29px; width: 75%;">
                        <i class="ti-search" onclick="timKiemMenu()"></i></p></form>
            </div>
            <div id="yeuthich">
                <i class="ti-heart"></i>
